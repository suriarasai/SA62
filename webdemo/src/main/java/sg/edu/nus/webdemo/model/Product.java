 ...
 *
 *             Data types: Long – id String – name, description, imageUrl, brand
 *             Double – price, discountPercent Integer – stockQuantity
...
public class Product {
	...
	//BigDecimal 
	//BigInteger (Industry Standard)
	// Precision - when you deal with money.
	...
	/**
	 * @ManyToOne – many products belong to one category; FK category_id on this
	 *            table.
	 */
	...
	/**
	 * @ManyToMany – owner side. Creates join table product_tags(product_id,
	 *             tag_id).
	 */
	...
	public void setStockQuantity(Integer sq) {
